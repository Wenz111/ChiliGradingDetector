...
import ChiliGradingDetector.Helper;
...
public class ChiliDataSetIterator {
    private static final Logger log = LoggerFactory.getLogger(ChiliDataSetIterator.class);
    ...
    private static void loadData() throws IOException {
        dataDir = Paths.get(
                ...
                Helper.getPropValues("current_directory.resources")
        ).toString();
