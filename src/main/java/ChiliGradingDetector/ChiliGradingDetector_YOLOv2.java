...
public class ChiliGradingDetector_YOLOv2 {
    ...
    private static final File modelFilename = new File(System.getProperty("user.dir"), "src/main/resources/generated-models/ChiliGradingDetector_yolov2.zip");
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        log.info("Model Filename Location: " + modelFilename.toString());
        if (modelFilename.exists()) {
            ...
            log.info("Model not found run else statement");
            Nd4j.getRandom().setSeed(seed);
